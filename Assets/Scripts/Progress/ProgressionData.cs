...
namespace DesktopPet.Progress
{
    ...
    public static class ProgressionDatabase
    {
        private static readonly FocusLevelDefinition[] focusLevels =
        {
            ...
            new() { displayName = "熟练", minFocus = 100, maxFocus = 199, durationMultiplier = 0.83f },
            new() { displayName = "精通", minFocus = 200, maxFocus = 299, durationMultiplier = 0.71f },
            new() { displayName = "专家", minFocus = 300, maxFocus = 399, durationMultiplier = 0.625f },
            new() { displayName = "大师", minFocus = 400, maxFocus = 500, durationMultiplier = 0.55f }
        };
